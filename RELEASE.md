...
5. [Restrict token access](https://docs.npmjs.com/trusted-publishers#recommended-restrict-token-access-when-using-trusted-publishers) for maximum security.
...
1. Publish to NPM with OIDC authentication
2. Generate and attach provenance attestations
...
2. Publish to NPM using trusted publishing
3. Create a GitHub release
